...
night-king-already-given = Ты уже разблокировал(а) секретную ачивку, она отобразится (или уже отобразилась) на Стаффе в течение 24ч после разблокировки

night-king-unavailable = Условия для получения секретной ачивки не выполнены, попробуй позже

night-king-unblocked = Ночной король 👑 разблокирован! Ачивка будет выдана и отобразится на Стаффе в течение 24ч
